...
${OBJECTDIR}/BinaryFileReader.o: BinaryFileReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryFileReader.o BinaryFileReader.cpp
...
${OBJECTDIR}/MultiScence.o: MultiScence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MultiScence.o MultiScence.cpp
...
${OBJECTDIR}/XDRScenceGroup.o: XDRScenceGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XDRScenceGroup.o XDRScenceGroup.cpp

${OBJECTDIR}/XDRUserGroup.o: XDRUserGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XDRUserGroup.o XDRUserGroup.cpp
